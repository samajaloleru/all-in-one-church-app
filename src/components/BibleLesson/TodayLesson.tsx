...
export const TodayLesson = ({ schedule }: { schedule: DateSchedule | null }) => {
  ...
  return (
    <div className="mb-10 mt-5 bg-gradient-to-r from-yellow-50 to-rose-50 rounded-2xl shadow-lg border border-rose-200 p-6">
      <div className="flex justify-between items-start mb-4">
        <h2 className="text-2xl font-bold text-rose-800">{t.todayLesson}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white p-4 rounded-xl shadow-sm">
          <h3 className="text-sm font-semibold text-rose-500 mb-1">{t.date}</h3>
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm">
          <h3 className="text-sm font-semibold text-rose-500 mb-1">{t.day}</h3>
          <p className="text-lg font-bold">{schedule.day}</p>
        </div>
        
        <div className="bg-white p-4 rounded-xl shadow-sm">
          <h3 className="text-sm font-semibold text-rose-500 mb-1">{t.sessions}</h3>
